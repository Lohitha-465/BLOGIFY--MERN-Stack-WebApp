...
const Homepage = () => {
  return (
    <div className="bg-gray-800"> {/* Set a dark grey background for the entire page */}
      <section className="relative bg-gray-900 overflow-hidden"> {/* Darker background for the section */}
          ...
          <div className="container px-4 mx-auto">
            <div className="flex flex-wrap items-center">
              <div className="w-full lg:w-1/2 mb-20 lg:mb-0">
                ...
                <p className="mb-8 text-lg md:text-xl leading-7 text-white font-medium"></p>
                <ul>
                  <li className="mb-6 flex items-center">
                    ...
                    />
                    <p className="text-lg md:text-xl leading-7 text-white font-medium">
                ...
                <Link
                  to="https://www.blogger.com/about/?bpli=1"
